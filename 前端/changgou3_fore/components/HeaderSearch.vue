  ...
  <div>
    <div class="header w1210 bc mt15">
          ...
          <div class="search_form">
            ...
            <form action name="serarch" method="get" class="fl">
              <input
                ...
                value="请输入商品关键字"
              />
              <input type="submit" @click.prevent="search" class="btn" value="搜索" />
            </form>
      ...
      <div class="nav w1210 bc mt10">
        <!--  商品分类部分 start-->
        <div :class="['category fl',isFirst?'':'cat1']">
          <!-- 非首页，需要添加cat1类 -->
          <div :class="['cat_hd',isFirst?'':'off']">
            <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
            <h2>全部商品分类</h2>
            <em></em>
          </div>

          <div :class="['cat_bd',isFirst?'':'none']">
